...
const faqItems = {
  EN: [
    ...
    {
      question: "What type of integrations are compatible with Aiphier?",
      answer:
        "Aiphier integrates seamlessly with popular CRM systems like Salesforce, HubSpot, and Pipedrive, as well as communication platforms such as Twilio, RingCentral, and Zoom Phone. We also support integration with calendar applications, email systems, and custom APIs to fit your specific workflow requirements.",
    },
    {
  ...
  ES: [
    {
      question: "¿Cómo funciona Aiphier?",
      answer:
        "El servicio principal de Aiphier es un Agente de Voz con IA que atiende llamadas entrantes, entiende la intención del cliente, ofrece respuestas automáticas inteligentes y redirige la llamada cuando es necesario. Se integra con tu sistema telefónico actual y mejora de forma continua con el uso. Además, ofrecemos automatizaciones de procesos en áreas como ventas, marketing y soporte.",
    },
    {
