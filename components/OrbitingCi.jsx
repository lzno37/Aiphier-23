...
const Orbiting = () => {
  ...
  const content = {
    EN: {
      ...
      description1:
        "Aiphier executes comprehensive actions throughout the patient journey - sending appointment confirmations, processing payment links, updating CRM systems, and managing WhatsApp communications automatically",
      title2: "Execute actions like a real person.",
      description2:
        "Aiphier sends emails, WhatsApps, payment links, reminders, and much more...",
      talkToSales: "Get Started",
    },
    ES: {
      title1: "Automatización Completa del Flujo de Trabajo.",
      description1:
        "Aiphier ejecuta acciones integrales durante todo el proceso del paciente: envía confirmaciones de citas, procesa enlaces de pago, actualiza sistemas CRM y gestiona comunicaciones de WhatsApp automáticamente",
      title2: "Ejecuta acciones como una persona real.",
      description2:
        "Aiphier envía correos electrónicos, WhatsApps, enlaces de pago, recordatorios y mucho más...",
