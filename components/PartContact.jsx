...
const PartContact = () => {
  ...
  const Lang = {
    EN: {
      badge: "Contact Us",
      title: "Built By us Amplified By You",
      name: "Name",
      company: "Company",
      ...
      button: "Try Now",
      agreeComms:
        "I agree to receive commercial communications and news about Aiphier via email. I understand that I can withdraw my consent at any time.",
      acceptTerms: "I accept the Privacy Policy and Legal Notice",
    },
    ES: {
      badge: "Contáctanos",
      title: "Construido por nosotros, amplificado por ti",
      name: "Nombre",
      company: "Empresa",
      ...
      button: "Probar ahora",
      agreeComms:
        "Acepto recibir comunicaciones comerciales y noticias sobre Aiphier por correo electrónico. Entiendo que puedo retirar mi consentimiento en cualquier momento.",
    ...
    <AuroraBackground>
      <section className="py-12 sm:py-16 lg:py-20 flex flex-col items-center z-20 justify-center px-4 sm:px-8 lg:px-16">
        <div className="flex justify-center">
          <span className="px-3 sm:px-4 py-2 mb-6 sm:mb-8 rounded-full border border-gray-200 bg-white text-[#196f95] text-xs font-light">
            {Lang[currentLanguage].badge}
          </span>
        </div>
        <form onSubmit={handleSubmit}>
          <div className="w-full max-w-2xl p-6 sm:p-8 lg:p-10 z-10 mx-auto font-sans">
            <h1 className="text-center text-2xl sm:text-3xl lg:text-4xl font-light mb-6 sm:mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-6">
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="Aiphier Technologies"
              ...
              <div>
                ...
                <input
                  type="email"
                  placeholder="support@aiphier.com"
