...
const Navbar = () => {
  ...
  const content = {
    EN: {
      ...
      tryNow: "Try Now",
      industriesList: {
        lawoffices: "Legal Services & Firms",
    ...
    ES: {
      ...
      tryNow: "Probar Ahora",
      industriesList: {
        lawoffices: "Servicios Legales y Bufetes de Abogados",
        propertymanagement: "Administradores de Fincas",
        healthcare: "Servicios de Salud y Medicina",
        restaurant: "Restaurantes y Hospitalidad",
      },
    },
  };
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4 space-y-4">
                  ...
                  <a
                    href="/contact"
                    onClick={() => setIsMobileMenuOpen(false)}
                    className="block w-full text-center p-4 rounded-full bg-black text-white font-medium"
                  >
                    {content[currentLanguage].tryNow}
                  </a>
                </div>
